...
exports.MediaQueryDto = exports.UpdateMediaDto = void 0;
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Descriptive alt text for accessibility' }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ enum: client_1.MediaType }),
    (0, class_validator_1.IsOptional)(),
